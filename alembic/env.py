...
from infrastructure.database.connection_factory import Base
...
def run_migrations_online():
    ...
    if db_configs["sqlalchemy.url"]:
        connectable = engine_from_config(
            db_configs, prefix="sqlalchemy.", poolclass=pool.NullPool
        )
    else:
        from infrastructure.database.connection_factory import _engine
